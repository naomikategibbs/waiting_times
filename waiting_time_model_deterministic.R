...
# options(scipen = 999)
# 
# start_time <- Sys.time() # recording the start time of the simulation run
# waiting_times_model(day_of_proc = 11, age = 61, female = 0, imd_quintile = 3,
#                     charlsonindex = 4.5, mean_wait = 63.467)
# end_time <- Sys.time() # recording the end time
# print(end_time - start_time) # report running time of model
...
# index for each sex/imd group
  ...
  simulation_subgroups[,1] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 0 & subgroup_data$imd_quintile == 1], female = 0, imd_quintile = 1,
  ...
  simulation_subgroups[,2] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 0 & subgroup_data$imd_quintile == 2], female = 0, imd_quintile = 2,
  ...
  simulation_subgroups[,3] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 0 & subgroup_data$imd_quintile == 3], female = 0, imd_quintile = 3,
  ...
  simulation_subgroups[,4] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 0 & subgroup_data$imd_quintile == 4], female = 0, imd_quintile = 4,
  ...
  simulation_subgroups[,5] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 0 & subgroup_data$imd_quintile == 5], female = 0, imd_quintile = 5,
  ...
  simulation_subgroups[,6] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 1 & subgroup_data$imd_quintile == 1], female = 1, imd_quintile = 1,
  ...
  simulation_subgroups[,7] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 1 & subgroup_data$imd_quintile == 2], female = 1, imd_quintile = 2,
  ...
  simulation_subgroups[,8] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 1 & subgroup_data$imd_quintile == 3], female = 1, imd_quintile = 3,
  ...
  simulation_subgroups[,9] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 1 & subgroup_data$imd_quintile == 4], female = 1, imd_quintile = 4,
  ...
  simulation_subgroups[,10] <- waiting_times_model(day_of_proc = 7*108, age = subgroup_data$age[subgroup_data$female == 1 & subgroup_data$imd_quintile == 5], female = 1, imd_quintile = 5,
